...
import { getHistory, clearOldRecords, adminDeleteRecent, adminDeleteSpecific, getCurrentUser, submitOutcomeFeedback, getOutcomeFeedback } from "@/lib/api";
            ...
            {feedbackStats ? (
                <Card className="border-border/50 bg-card p-4">
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 text-sm">
                        <p>Outcome feedback records: <span className="font-semibold">{feedbackStats.count}</span></p>
                        <p>Predicted vs actual agreement: <span className="font-semibold">{feedbackStats.agreement_rate.toFixed(1)}%</span></p>
                    </div>
                                                            ...
                                                            <div className="mt-4 rounded-lg border border-border/50 bg-card p-3">
                                                                ...
                                                                <div className="mt-2 grid grid-cols-1 gap-2 md:grid-cols-4">
                                                                    <select
                                                                        ...
                                                                        className="h-9 rounded-md border border-input bg-input/50 px-3 text-xs"
                                                                    ...
                                                                    <Input
                                                                        ...
                                                                        className="h-9 bg-input/50 text-xs"
                                                                ...
                                                                <Input
                                                                    ...
                                                                    className="mt-2 h-9 bg-input/50 text-xs"
